...
{
	/// <summary>
	/// Helper class customizes the standard MenuEntry class for displaying AvailableNetworkSession objects.
	/// </summary>
	public class AvailableSessionMenuEntry : MenuEntry
	{
		...
		/// </summary>
		public AvailableSessionMenuEntry(AvailableNetworkSession availableSession) : base(GetMenuItemText(availableSession))
		{

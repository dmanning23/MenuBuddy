...
namespace MenuBuddy
{
	...
	class NetworkSessionComponent : GameComponent
	{
		...
		/// </summary>
		NetworkSessionComponent(ScreenManager screenManager, NetworkSession networkSession) : base(screenManager.Game)
		{
		...
		public override void Initialize()
		{
			...
			// Look up the IMessageDisplay service, which will be used to report gamer join/leave notifications.
			messageDisplay = (IMessageDisplay)Game.Services.GetService(typeof(IMessageDisplay));
		...
		public override void Update(GameTime gameTime)
		{
			...
			catch (Exception exception)
			{
				...
				sessionEndMessage = "There was an error while \naccessing the network";
		...
		void GamerJoined(object sender, GamerJoinedEventArgs e)
		{
			...
			{
				messageDisplay.ShowMessage("{0} joined", e.Gamer.Gamertag);
			}
		}
		...
		void GamerLeft(object sender, GamerLeftEventArgs e)
		{
			if (notifyWhenPlayersJoinOrLeave)
			{
				messageDisplay.ShowMessage("{0} left", e.Gamer.Gamertag);
			}
		}
		...
		/// </summary>
		static void JoinInvitedOperationCompleted(object sender, OperationCompletedEventArgs e)
		{
			...
			try
			{
				...
				NetworkSession networkSession = NetworkSession.EndJoinInvited(e.AsyncResult);

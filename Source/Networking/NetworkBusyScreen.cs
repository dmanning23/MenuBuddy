...
namespace MenuBuddy
{
	...
	/// </summary>
	public class NetworkBusyScreen : GameScreen
	{
		#region Fields
		...
		public override void LoadContent()
		{
			...
			catTexture = content.Load<Texture2D>(@"Resources\Textures\hourglass");
		}
		...
		public override void Draw(GameTime gameTime)
		{
			...
			Vector2 catSize = new Vector2(catTexture.Width * 2.0f);
			...
			Vector2 catPosition = new Vector2(textPosition.X + textSize.X / 2,
											  textPosition.Y + textSize.Y - catSize.Y / 2);

			Vector2 catOrigin = new Vector2(catTexture.Width / 2.0f, catTexture.Height / 2.0f);

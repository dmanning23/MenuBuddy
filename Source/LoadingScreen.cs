...
namespace MenuBuddy
{
	...
	public class LoadingScreen : GameScreen
	{
		...
		{
			m_LoadingIsSlow = loadingIsSlow;
			m_ScreensToLoad = screensToLoad;
		...
		{
			//TODO: first stop playing teh music
		...
		public override void Draw(GameTime gameTime)
		{
			...
			if (m_LoadingIsSlow)
			{
				...
				Color myColor = new Color(1.0f, 0.25f, 1.0f, TransitionAlpha);
				...
				// Draw the text.
				spriteBatch.Begin();
				spriteBatch.DrawString(font, message, textPosition, myColor);
				spriteBatch.End();
			}
		}
		...
		void DrawLoadAnimation(GameTime gameTime)
		{
			...
			try
			{
				graphicsDevice.Clear(FadeAlphaDuringTransition(Color.White));
